...
# Описание проекта
Проект посвящён прогнозированию цен на авто. 

Была создана полноценная модель по входным параметрам. Для создания качественной модели были использованы такие библиотеки, как sklearn, optuna, autofeat и др. Сервисы, по типу mlflow, позволили качественно отслеживать результаты различных моделей и проводить их сравнение при помощи метрик.
